...
public class LBMemberSerializer extends JsonSerializer<LBMember>{
    ...
    public void serialize(LBMember member, JsonGenerator jGen,
        ...
        jGen.writeStringField("address", member.addressStr);
        ...
        jGen.writeStringField("admin_state_up", Short.toString(member.adminState));
        jGen.writeStringField("weight", String.valueOf(member.weight));
